 ...
 * Generation date: 2026-05-29T14:51:25.344509+08:00
 */
...
interface UserQuotaGrantsMapper {
    ...
    fun insertMultiple(@Param("insertStatement") insertStatement: String, @Param("records") records: List<UserQuotaGrantsRecord>): Int
    ...
    @Results(id="UserQuotaGrantsRecordResult", value = [
        ...
        Result(column="granted_amount", property="grantedAmount", jdbcType=JdbcType.DECIMAL),
        Result(column="remaining_amount", property="remainingAmount", jdbcType=JdbcType.DECIMAL),
        Result(column="consumed_amount", property="consumedAmount", jdbcType=JdbcType.DECIMAL),
