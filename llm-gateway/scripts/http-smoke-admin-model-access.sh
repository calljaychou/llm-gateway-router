...
USERNAME="${2:-admin}"
PASSWORD="${3:-123456}"
VENDOR_NAME="${4:-Deepseek-SMOKE-$(date +%s)}"
VENDOR_BASE_URL="${5:-https://api.deepseek.com}"
MASTER_KEY_PLAIN="${6:-sk-72e12834312c4731a1fd9c9d5444cd9b}"
MODEL_ALIAS="${7:-deepseek-v4-flash-smoke-$(date +%s)}"
REAL_MODEL_NAME="${8:-deepseek-v4-flash}"
